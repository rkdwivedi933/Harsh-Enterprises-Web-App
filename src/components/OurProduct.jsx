  ...
  return (
    <div className='mt-5 text-center font-bold text-2xl transition-transform transform hover:scale-105 hover:shadow-2xl'>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 p-4">
        ...
        {/* Product 1 */}
        <div
          onClick={() => navigate('/sheedling-Tray')}
          className="bg-white shadow-md rounded-md overflow-hidden flex flex-col items-center p-4 transition-transform transform hover:scale-105 hover:shadow-2xl"
        >
          <img
            src={Tray}
            alt="SEEDLING TRAY"
